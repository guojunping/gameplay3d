...
public:
	...
	*   array.
	*/
	void setData(int offx, int offy, int w, int h, const unsigned char* data);
	...
	/**
	*  Copying data from one texture .
	*/
	void copyTexture(Texture *srcTex, int offx, int offy, int x, int y, int w, int h);
